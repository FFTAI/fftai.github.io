...
# Purpose of the Developer Guide
 ...
 This guide introduces the app's functionalities and serves as an indispensable resource for developers looking to comprehend the app's inner workings and refine it with precision for potential market deployment.
...
* [Accessing and Modifying Robot Settings](demo_app/settings.md)
* [Building Your Own Remote Control App](demo_app/app_project_setup.md)
